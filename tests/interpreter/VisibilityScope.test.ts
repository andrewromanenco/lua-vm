...
describe('VisibilityScope', () => {
  it('root scope', () => {
    ...
    expect(rootScope.get(StringValue.from('non-existing'))).toBeInstanceOf(
      NilValue
    );
    rootScope.set(StringValue.from('x'), StringValue.from('y'));
    expect(rootScope.get(StringValue.from('x'))).toBeInstanceOf(StringValue);
    expect((rootScope.get(StringValue.from('x')) as StringValue).string).toBe(
      'y'
    );
  });
  ...
  it('child scope', () => {
    ...
    expect(childScope.get(StringValue.from('non-existing'))).toBeInstanceOf(
      NilValue
    );
    ...
    expect((childScope.get(StringValue.from('x')) as StringValue).string).toBe(
      'y'
    );
    ...
    expect((childScope.get(StringValue.from('n')) as StringValue).string).toBe(
      'm'
    );
  });
});
